...
from .views import home, portfolio_detail, transaction_delete, transaction_update, portfolio_update, transaction_add, balance_item_add, transfer_add, transfer_delete
urlpatterns = [
    path('', home, name='home'),
